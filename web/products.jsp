    ...
    <div id="templatemo_wrapper">
        ...
        <div id="templatemo_main">
            ...
            <div id="content" class="float_r">
                ...
                <c:forEach items="${requestScope.records}" var="product" varStatus="vs">
                    <c:choose>
                        <c:when test="${7 == product.cid}">
                            <div style="width: 620px" class="${vs.index % 3 != 2?'product_box':'product_box no_margin_right' }">
                            <a href="${pageContext.request.contextPath }/ProductServlet?op=findProductsByName&pname=${product.desc}">
