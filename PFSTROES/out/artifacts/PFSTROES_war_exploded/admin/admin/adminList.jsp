	...
	<table width="100%" border="0" align="center" cellpadding="0"
		...
		<tr>
			<td><table width="100%" border="0" cellpadding="0"
					...
					<c:forEach items="${sessionScope.records }" var="admin">
						<tr>
						...
						<td height="20" bgcolor="#FFFFFF">
							<div align="center" class="STYLE21">
								...
								<a href="${pageContext.request.contextPath }/admin/admin/updateAdmin.jsp?op=updateAdmin&aid=${admin.aid}&username=${admin.username}&password=${admin.password}">编辑</a>
							</div>
						</td>
					</tr>
					</c:forEach>
