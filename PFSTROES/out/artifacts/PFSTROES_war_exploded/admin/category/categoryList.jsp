...
<%@ page import="com.cskaoyan.utils.PageCategoryInfo" %>
...
<script type="text/javascript" src="${pageContext.request.contextPath }/admin/js/jquery.js"></script>
	<script type="text/javascript">
		function checkDelete(cid) {
		    if(confirm("是否确认删除？")){
		        location.href="/CategoryServlet?op=deleteCategory&cid="+cid;
			}
        }
	</script>
<title>无标题文档</title>
	...
	<table width="100%" border="0" align="center" cellpadding="0"
		...
		<tr>
			<td><table width="100%" border="0" cellpadding="0"
				...
				<%PageCategoryInfo pageinfo=(PageCategoryInfo) session.getAttribute("pageinfo");%>
				<%List<Category> categories= pageinfo.getPageList();%>
				...
				<tr>
					...
					<td width="10%" height="20" bgcolor="#FFFFFF" class="STYLE6">
						<div align="center">
							<span class="STYLE10"><%out.print(category.getCid());%></span>
						</div>
					</td>
					<td width="15%" height="20" bgcolor="#FFFFFF" class="STYLE6">
						<div align="center">
							<span class="STYLE10"><%out.print(category.getCname());%></span>
						</div>
					</td>
					<td width="14%" height="20" bgcolor="#FFFFFF" class="STYLE6">
						<div align="center">
							<div align="center" class="STYLE21">
								<a href="/admin/category/updateCategory.jsp?cid=<%out.print(category.getCid());%>&cname=<%out.print(category.getCname());%>">编辑</a>
								|
								<a href="javascript:checkDelete(<%out.print(category.getCid());%>)">删除</a>
							</div>
						</div>
					</td>
				</tr>
					...
					<tr>
						<td width="33%"><div align="left">
								<span class="STYLE22">&nbsp;&nbsp;&nbsp;&nbsp;共有<strong>
									<%=pageinfo.getZongJLnum()%></strong> 条记录，当前第<strong><%=pageinfo.getDQnum()%>></strong> 页，共 <strong><%=pageinfo.getZYnum()%>></strong> 页</span>
						</div>
						</td>
						<td width="67%">
							<table width="312" border="0" align="right" cellpadding="0" cellspacing="0">
								<tr>
									...
									<td width="49">
										<div align="center">
											<span class="STYLE22">
											<a href="${pageContext.request.contextPath }/CategoryServlet?op=findAllCategory&num=<%=pageinfo.getQYnum()%>">上一页</a>
											</span>
										</div>
									</td>
									<td width="49"><span class="STYLE22">
									    <div align="center">
											<span class="STYLE22">
											<a href="${pageContext.request.contextPath }/CategoryServlet?op=findAllCategory&num=<%=pageinfo.getNaxtNum()%>">下一页</a>
											</span>
										</div>
									</td>
									<td width="49">
										<div align="center">
											<span class="STYLE22"><a href="${pageContext.request.contextPath }//CategoryServlet?op=findAllCategory&num=<%=pageinfo.getZYnum()%>">尾页</a></span>
										</div>
									</td>
									...
									<td width="22">
										<div align="center">
											<input type="text" name="num" id="num" value="<%=pageinfo.getDQnum()
